import{o as Qh,_ as Bt,r as mt,S as ns,a as Jh,b as is,c as rr}from"./index-e3d5d3f4.hAq-HhCS.js";import{f as Zh,B as tc,s as bo,v as Po,c as Mo,x as Lo,y as xo,z as Fo,A as Uo}from"./scheduler.B2r9yBIf.js";import{S as Bo,i as Ho,d as he,v as $o,r as cn,h as Wo,C as Rt,E as jo,A as se,B as Vo,f as Go}from"./index.hWTjKFm_.js";import{w as ri}from"./index.CrHfgNqt.js";function un(e,t=null){let n;if(!globalThis.window){const{subscribe:s}=ri(t);return{subscribe:s}}if(!e){console.warn("Firebase Auth is not initialized. Are you missing FirebaseApp as a parent component?");const{subscribe:s}=ri(null);return{subscribe:s}}const{subscribe:i}=ri((e==null?void 0:e.currentUser)??null,s=>(n=Qh(e,r=>{s(r)}),()=>n()));return{subscribe:i}}var or={};/**
 * @license
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function Nm(e){Vp(ns),Bt(new Up("database",(t,{instanceIdentifier:n})=>{const i=t.getProvider("app").getImmediate(),s=t.getProvider("auth-internal"),r=t.getProvider("app-check-internal");return Im(i,s,r,n)},"PUBLIC").setMultipleInstances(!0)),mt(Qr,Jr,e),mt(Qr,Jr,"esm2017")}Ct.prototype.simpleListen=function(e,t){this.sendRequest("q",{p:e},t)};Ct.prototype.echo=function(e,t){this.sendRequest("echo",{d:e},t)};Nm();export{Fm as P,Bm as S,Hm as a,Um as s};
